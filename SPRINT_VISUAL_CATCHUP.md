...
### Ticket P.2 — Student profile creation screen
**Task:** Apply the same visual treatment, rounded cards/buttons, Baloo
2 typography, friendly copy, to the student profile creation flow
(creating a first student, adding a sibling).

**Done when:** Profile creation screens match the established style,
verified visually.
